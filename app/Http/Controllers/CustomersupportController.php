...
class CustomersupportController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($country_code == "KW") {
            ...
            $slug = "customer-support-" . $country_code . "-" . $this->current_language;
            ...
            $slug = "customer-support-uae-" . $this->current_language;
        }
        // echo $slug;
        // exit;
        // var_dump($slug);
        ...
        return view('customer-support', compact('page', 'pageSections', 'banner', 'lang_url_switcher', 'slugval'));
    }
}
