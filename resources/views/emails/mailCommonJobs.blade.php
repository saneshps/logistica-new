...
<head>
  <meta charset="UTF-8">
  <title> Email Template: Logistica </title>
                                    ...
                                    <div class="text-element paragraph">
                                      <div
                                        style="color: rgb(51, 51, 51); font-family: 'Exo 2', sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                        		 <p style="font-size: 18px;font-weight: 600;">{{__('jobs_enquiry_message')}}:</p>
                                                        <ul style="background: white;
                                                    list-style: none;
                                                    padding: 16px;font-size: 14px;">

                                                            <li>{{__('name')}}:-&nbsp;&nbsp;{{ $data['name'] }}</li>
                                                            <li>{{__('phone')}}:-&nbsp;&nbsp;<a href="tel:{{ $data['phone'] }}">{{ $data['phone'] }}</a></li>
                                                            <li>{{__('email')}}:-&nbsp;&nbsp;<a href="mailto:{{ $data['email'] }}">{{ $data['email'] }}</a></li>
															<li>{{__('country')}}:-&nbsp;&nbsp;{{ $data['country'] }}</li>
                                                            <li>{{__('role_applied')}}:-&nbsp;&nbsp;{{ $data['role'] }}</li>
															<li>{{__('description')}}:-&nbsp;&nbsp;{{ $data['description'] }}</li>
                                                            <li>{{__('resume')}}:-&nbsp;&nbsp;<a href="{{ asset('uploads/pdf') }}/{{ $data['resume'] }}">{{__('download')}}</a></li>
                                            ...
                                            <td align="center"
                                              ...
                                              <a href="#"
                                                ...
                                                <img
                                                  ...
                                                  alt="Facebook Icon"
                                                  src="{{asset('assets/img/facebook.png')}}"
                                  ...
                                  <div class="definition-parent">
                                    <div class="text-element paragraph">
                                      <div
                                       ...
                                       <a href="#"> Bahrain </a> ||  <a href="#"> Kuwait </a> ||  <a href="#">  United Arab Emirates </a> </div>

                                        <div
                                          style="text-align: center; color: rgb(124, 124, 124); font-family: 'Exo 2', sans-serif; font-size: 14px; line-height: 125%; font-weight: 400;">
                                          <br>
                                          <a class="validating" href="https://logistica-group.com"
                                            ...
                                            href="https://logistica-group.com"
                                            style="color:#017ac9; font-weight: 100; font-size: 13px;" target="_blank"
                          ...
                          <table style="width: 100%; border-spacing: 0; padding: 6px 0; background: #cbcbcb; letter-spacing: 2px; border-radius: 0 0 8px 8px; margin-top: 20px;">
                            <tbody><tr>
                              <td style="width: 100%; text-align: center;">
                                <a style="text-decoration: none; color: #fff; margin: 0; font-size: 12px;"> www.logistica-group.com </a>
                              </td>
                            </tr>
                            </tbody></table>
